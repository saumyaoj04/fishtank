...
//(private val assets:List<String>,private val image:List<Int>,private val price:List<String>, private val inc:List<String>): RecyclerView.Adapter<AssetAdapter.AssetViewHolder>() {
//
//
